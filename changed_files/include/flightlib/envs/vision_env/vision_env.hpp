...
enum Vision : int {
  ...
  // observations     + kNObstacles * kNObstaclesState
  kObs = 0,
  kNObs = 16,
...
class VisionEnv final : public EnvBase {
 public:
  ...
  std::vector<std::shared_ptr<UnityObject>> base_static_objects_;
 ...
 private:
  ...
  bool randomise_ball_position = false;
  long current_step = 0;
  Scalar survive_reward_distance = 60;
  Scalar end_distance = 63;
